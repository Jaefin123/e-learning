...
<main class="min-h-screen">
    ...
    <div class="p-12 max-w-7xl mx-auto space-y-16">
        ...
        <section class="flex flex-col md:flex-row justify-between items-end gap-8">
            <div class="max-w-2xl">
                <span
                    class="font-headline uppercase text-xs tracking-[0.2em] font-bold text-primary mb-4 block">Ikhtisar
                    Kurikulum</span>
                <h2 class="text-6xl font-headline font-black text-on-surface tracking-tighter leading-none mb-6">Manajemen
                    <br /> Mata Kuliah</h2>
                <p class="text-lg text-on-surface-variant font-body leading-relaxed">
                    Kelola mata kuliah dengan rapi dan terarah. Semester ini berfokus pada penguatan <span
                        class="italic text-primary">dasar pemrograman</span> serta <span
                        class="italic text-primary">logika komputasi</span>.
                </p>
            </div>
            <div class="flex flex-col items-end text-right">
                <div class="text-4xl font-headline font-bold text-purple-900">08</div>
                <div class="font-headline uppercase text-[10px] tracking-widest font-bold text-slate-400">Modul Aktif
                </div>
            </div>
        </section>
        <!-- Grid Mata Kuliah -->
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-8 group cursor-pointer">
                <div
                    ...
                    <img alt="Pemrograman Dasar"
                        class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        data-alt="mahasiswa teknik komputer sedang menulis kode program di laboratorium komputer"
                    ...
                    <div class="absolute bottom-0 left-0 p-10 z-20 w-full flex justify-between items-end">
                        <div class="space-y-2">
                            <span
                                class="font-headline uppercase text-[10px] tracking-[0.2em] font-bold text-primary-fixed block">Semester
                                Genap 2024</span>
                            <h3 class="text-4xl font-headline font-extrabold text-white">Pemrograman Dasar
                            </h3>
                            <div
                                class="flex items-center space-x-4 text-white/80 font-headline text-xs font-semibold uppercase tracking-widest mt-4">
                                <span class="flex items-center"><span
                                        class="material-symbols-outlined text-sm mr-1">groups</span> 124 Mahasiswa</span>
                                <span class="flex items-center"><span
            ...
            <div class="md:col-span-4 h-full">
                <div class="bg-surface-container-low p-10 h-full rounded-xl flex flex-col justify-between">
                    <div class="space-y-6">
                        <span
                            class="font-headline uppercase text-[10px] tracking-[0.2em] font-bold text-secondary block">Algoritma
                            dan Struktur Data</span>
                        <h3 class="text-3xl font-body font-bold leading-tight">Strategi Pemecahan Masalah Komputasi
                        </h3>
            ...
            <div class="md:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="flex justify-between items-start">
                        <div class="w-12 h-12 bg-tertiary-fixed rounded-lg flex items-center justify-center">
                            <span class="material-symbols-outlined text-tertiary">function</span>
                        </div>
                        <span class="font-headline text-[10px] uppercase font-bold tracking-widest text-slate-400">Semester
                            02</span>
                    </div>
                    <div>
                        <h4 class="text-xl font-headline font-bold text-on-surface">Matematika Diskrit</h4>
                        <p class="text-sm text-on-surface-variant mt-2 font-body">Membahas logika, relasi, graf, dan
                            dasar pembuktian untuk ilmu komputer.</p>
                    </div>
                    <div class="flex items-center justify-between pt-4">
                        <div class="flex -space-x-2">
                            <img class="w-8 h-8 rounded-full border-2 border-white object-cover"
                                data-alt="potret mahasiswa teknik komputer"
                            ...
                            <img class="w-8 h-8 rounded-full border-2 border-white object-cover"
                                data-alt="potret mahasiswi teknik komputer"
                ...
                <div
                    ...
                    <div>
                        <h4 class="text-xl font-headline font-bold text-on-surface">Basis Data</h4>
                        <p class="text-sm text-on-surface-variant mt-2 font-body">Perancangan skema, query SQL, dan
                            normalisasi data untuk aplikasi modern.</p>
                    </div>
                    <div class="flex items-center justify-between pt-4">
                        <div class="flex -space-x-2">
                            <img class="w-8 h-8 rounded-full border-2 border-white object-cover"
                                data-alt="potret dosen atau mahasiswa dengan kacamata"
                            ...
                            <img class="w-8 h-8 rounded-full border-2 border-white object-cover"
                                data-alt="potret mahasiswi dengan ekspresi fokus"
                ...
                <div
                    ...
                    <div>
                        <h4 class="text-lg font-headline font-bold text-on-surface">Fisika Dasar</h4>
                        <p class="text-xs text-slate-400 mt-1 uppercase tracking-widest font-bold">Mekanika dan Listrik</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section
            ...
            <div class="text-center">
                <div class="text-sm font-headline uppercase tracking-[0.2em] font-bold text-slate-400 mb-2">Rata-rata IPK
                </div>
                <div class="text-5xl font-headline font-black text-secondary">3.82</div>
            </div>
            <div class="h-12 w-px bg-outline-variant/20 hidden md:block"></div>
            <div class="text-center">
                <div class="text-sm font-headline uppercase tracking-[0.2em] font-bold text-slate-400 mb-2">Tingkat
                    Pengumpulan</div>
