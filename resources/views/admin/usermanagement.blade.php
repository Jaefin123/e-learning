...
<main class="min-h-screen transition-all duration-300">
    ...
    <div class="p-12 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div class="max-w-2xl">
                <span class="font-sans uppercase text-xs tracking-[0.2em] font-bold text-primary mb-4 block">Direktori Pusat</span>
                ...
                <p class="serif-content text-xl text-on-surface-variant leading-relaxed">
                    Mengelola modal intelektual lembaga. Awasi penunjukan dosen dan status akademik mahasiswa dalam satu tampilan editorial terpadu.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div
                ...
                <div>
                    <p class="text-slate-500 text-sm font-bold uppercase tracking-wider mb-2">Total Komunitas</p>
        ...
        <div class="bg-surface-container-low rounded-t-3xl p-6 flex flex-wrap items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                <div class="flex bg-surface-container-high rounded-full p-1">
                    <button class="px-6 py-2 rounded-full text-sm font-bold bg-white text-primary shadow-sm">Semua Pengguna</button>
                    <button
                        class="px-6 py-2 rounded-full text-sm font-bold text-slate-500 hover:text-primary transition-colors">Mahasiswa</button>
                    <button
                        class="px-6 py-2 rounded-full text-sm font-bold text-slate-500 hover:text-primary transition-colors">Dosen</button>
                    <button
                        class="px-6 py-2 rounded-full text-sm font-bold text-slate-500 hover:text-primary transition-colors">Staf</button>
                </div>
        ...
        <div class="bg-surface-container-lowest rounded-b-3xl overflow-hidden mb-16">
                    ...
                    <tr class="hover:bg-primary-fixed/30 transition-colors duration-300">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-headline font-bold text-on-surface">Dr. Sutomo</p>
                                    <p class="text-xs text-on-surface-variant font-medium">
                                        sutomo@academic.edu</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                            <span
                                class="px-3 py-1 bg-primary/10 text-primary rounded text-[11px] font-bold uppercase tracking-wider">Dosen</span>
                        </td>
                        <td class="px-8 py-6">
                    ...
                    <tr class="hover:bg-primary-fixed/30 transition-colors duration-300">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-headline font-bold text-on-surface">Endah Lestari</p>
                                    <p class="text-xs text-on-surface-variant font-medium">e.Lestari.24@student.edu
                                    </p>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                            <span
                                class="px-3 py-1 bg-secondary/10 text-secondary rounded text-[11px] font-bold uppercase tracking-wider">Mahasiswa</span>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-emerald-500 rounded-full"></span>
                    ...
                    <tr class="hover:bg-primary-fixed/30 transition-colors duration-300">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-headline font-bold text-on-surface">Markus Imanuel</p>
                                    <p class="text-xs text-on-surface-variant font-medium">m.imanuel@academiceditorial.edu
                                    </p>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
                            <span
                                class="px-3 py-1 bg-tertiary/10 text-tertiary rounded text-[11px] font-bold uppercase tracking-wider">Petugas Administrasi</span>
                        </td>
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-2">
                                <span class="w-2 h-2 bg-slate-300 rounded-full"></span>
                                <span class="text-sm font-medium text-slate-500">Tidak Aktif</span>
                            </div>
                        </td>
                    ...
                    <tr class="hover:bg-primary-fixed/30 transition-colors duration-300">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-headline font-bold text-on-surface">Sarah Sati</p>
                                    <p class="text-xs text-on-surface-variant font-medium">
                                        s.sati@academiceditorial.edu</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
            ...
            <div class="px-8 py-6 bg-surface-container-low flex items-center justify-between">
                        <p class="text-sm text-on-surface-variant font-medium">Menampilkan 1-10 dari 12.482 anggota</p>
                <div class="flex gap-2">
                    <button
        ...
        <div class="relative bg-surface-container-high rounded-[2.5rem] p-12 overflow-hidden">
            ...
            <div class="relative z-10 max-w-lg">
                ...
                <p class="serif-content text-lg text-on-surface-variant mb-8 leading-relaxed">
                    Jika Anda mendaftarkan keseluruhan angkatan atau departemen dosen, gunakan sistem unggah terstruktur kami untuk
