    ...
    <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 lg:col-span-7 bg-surface-container-lowest rounded-[2rem] p-10 editorial-shadow">
            <div class="flex justify-between items-start mb-10">
                <div>
                    <h3 class="font-display text-2xl font-bold text-on-surface">Buat Mata Kuliah Baru</h3>
                    <p class="text-on-surface-variant text-sm font-body">Siapkan modul akademik baru</p>
                </div>
            ...
            <form class="space-y-8">
                <div class="space-y-1">
                    <label
                        class="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 ml-1">Judul
                        Mata Kuliah</label>
                    <input
                        ...
                        placeholder="contoh: Pemrograman Dasar" type="text" />
                </div>
                <div class="grid grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label
                            class="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 ml-1">Jurusan</label>
                        <select
                    ...
                    <div class="space-y-1">
                        <label
                            class="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 ml-1">Tahun
                            Akademik</label>
                        <input
                            class="w-full bg-surface-container-high border-none rounded-xl py-4 px-5 focus:ring-2 focus:ring-primary/40 font-body transition-all"
                ...
                <div class="space-y-1">
                    <label
                        class="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 ml-1">Deskripsi
                        Mata Kuliah</label>
                    <textarea
                        class="w-full bg-surface-container-high border-none rounded-xl py-4 px-5 focus:ring-2 focus:ring-primary/40 font-body placeholder:text-on-surface-variant/40 transition-all"
                        placeholder="Jelaskan cakupan materi, capaian pembelajaran, dan prasyarat mata kuliah..." rows="4"></textarea>
                </div>
                <div class="pt-4 flex items-center justify-between">
                    <div class="flex items-center space-x-2 text-on-surface-variant/60 text-xs italic">
                        ...
                        <span>Draf tersimpan otomatis ke profil Anda.</span>
                    </div>
                    <button
        ...
        <div class="col-span-12 lg:col-span-5 space-y-8">
            ...
            <div class="bg-surface-container-lowest rounded-[2rem] p-8 editorial-shadow">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="font-display text-xl font-bold text-on-surface">Dosen Pengampu</h3>
                    <button
                ...
                <div class="space-y-4">
                    <div
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 rounded-lg bg-surface-container-high overflow-hidden">
                                <img alt="Dosen"
                                    data-alt="potret dosen Teknik Komputer di lingkungan kampus"
                            ...
                            <div>
                                <p class="font-headline font-bold text-sm text-on-surface">Dr. Sutomo</p>
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="w-12 h-12 rounded-lg bg-surface-container-high overflow-hidden">
                                <img alt="Dosen"
                                    data-alt="potret profesor Teknik Komputer dengan suasana akademik"
                            ...
                            <div>
                                <p class="font-headline font-bold text-sm text-on-surface">Prof. Ahmad</p>
                                <p class="font-label text-[10px] text-on-surface-variant uppercase tracking-wider">
                                    Ketua Jurusan</p>
                            </div>
                        </div>
            ...
            <!-- Bagian Mahasiswa Terdaftar -->
            <div class="bg-surface-container-low rounded-[2rem] p-8 border border-white/40">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="font-display text-xl font-bold text-on-surface">Mahasiswa Terdaftar</h3>
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-4 bg-surface-container-lowest p-3 rounded-2xl">
                        <div class="flex -space-x-3 overflow-hidden">
                            <img alt="Mahasiswa" class="inline-block h-8 w-8 rounded-full ring-2 ring-white"
                                data-alt="potret mahasiswi Teknik Komputer dengan latar kampus"
                            ...
                            <img alt="Mahasiswa" class="inline-block h-8 w-8 rounded-full ring-2 ring-white"
                                data-alt="potret mahasiswa Teknik Komputer di perpustakaan"
                            ...
                            <img alt="Mahasiswa" class="inline-block h-8 w-8 rounded-full ring-2 ring-white"
                                data-alt="potret mahasiswi Teknik Komputer tersenyum"
                        ...
                        <span class="text-xs text-on-surface-variant font-body italic">Baru bergabung ke
                            katalog</span>
                    </div>
                    <div class="relative group">
                        <input
                            ...
                            placeholder="Tambah mahasiswa berdasarkan nama atau NIM..." type="text" />
                        <span
                    ...
                    <!-- Daftar Mini Mahasiswa -->
                    <div class="space-y-3 pt-2">
                        <div class="flex items-center justify-between text-sm">
                            <span class="font-headline font-medium text-on-surface-variant">Raka Pratama</span>
                            <span
                                class="font-label text-[9px] uppercase bg-secondary-container/30 text-on-secondary-fixed-variant px-2 py-1 rounded">Reguler</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="font-headline font-medium text-on-surface-variant">Nadia Putri</span>
                            <span
                                class="font-label text-[9px] uppercase bg-tertiary-fixed/30 text-on-tertiary-fixed-variant px-2 py-1 rounded">Pilihan</span>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Progres Timeline Akademik -->
        ...
        <div class="col-span-12 mt-8">
            <div
                ...
                <div class="md:w-1/3 h-full relative">
                    <img alt="Laboratorium Komputer" class="absolute inset-0 w-full h-full object-cover"
                        data-alt="laboratorium komputer modern dengan perangkat pembelajaran dan layar kode program"
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-8">
                        <div>
                            <span class="font-label text-white/70 text-[10px] uppercase tracking-[0.3em]">Preview
                                Modul</span>
                            <p class="text-white font-headline text-lg font-bold">Visualisasi Kurikulum</p>
                        </div>
                    </div>
                </div>
                <div class="md:w-2/3 p-12 flex flex-col justify-center">
                    <h3 class="font-display text-3xl font-bold text-on-surface mb-6 italic">"Fondasi sistem yang baik
                        dimulai dari logika dan praktik yang kuat."</h3>
                    <p class="text-on-surface-variant font-body text-lg leading-relaxed mb-8">
                        Gunakan visualisasi kurikulum untuk memetakan hubungan antara pertemuan, tugas, praktikum, dan
                        materi pendukung. Desain mata kuliah akan langsung tampil di portal mahasiswa setelah diterbitkan.
                    </p>
